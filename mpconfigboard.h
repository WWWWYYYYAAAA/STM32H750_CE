...
#define MICROPY_HW_BOARD_NAME "H750VBT6_CE"
#define MICROPY_HW_MCU_NAME "STM32H750VBT6"
#define MICROPY_HW_FLASH_FS_LABEL "H750VBT6_CE"
...
#define MICROPY_BOARD_EARLY_INIT H750VBT6_board_early_init
void H750VBT6_board_early_init(void);
...
#define MICROPY_HW_SPI3_NSS         (pin_D7)
#define MICROPY_HW_SPI3_SCK         (pin_B6)
#define MICROPY_HW_SPI3_MISO        (pin_B4)
#define MICROPY_HW_SPI3_MOSI        (pin_B8)
...
#define MICROPY_HW_USRSW2_PIN       (pin_C13)
#define MICROPY_HW_USRSW2_PULL      (GPIO_PULLUP)
#define MICROPY_HW_USRSW2_EXTI_MODE (GPIO_MODE_IT_FALLING)
#define MICROPY_HW_USRSW2_PRESSED   (0)

// LEDs
#define MICROPY_HW_LED1 (pin_E7) // BLUE_LED, the only controlable LED on the board.
